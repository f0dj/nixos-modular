/**
 * @file: modules/home/editors/nixvim/core/sets.nix
 * @purpose: Standard Neovim options (set) for NixVim.
 * @type: Module
 * @namespace: my
 */
{ config, lib, pkgs, ... }:
  ...
  config = lib.mkIf cfg.enable {
    programs.nixvim = {
      ...
      opts = {
        ...
        # Disable intro message and file info to avoid hit-enter prompts
        shortmess = "aIF";
